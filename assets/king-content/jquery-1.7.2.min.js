...
(function(t, n) {
        ...
        if (1 === b.nodeType && c.hasData(a)) {
            ...
            if (h)
                ...
                h)
                    for (f = 0,
                    e = h[d].length; f < e; f++)
                        c.event.add(b, d, h[d][f]);
            g.data && (g.data = c.extend({}, g.data))
        }
    }
    function w(a, b) {
        var d, e, f = 0, g = typeof a.getElementsByTagName !== x ? a.getElementsByTagName(b || "*") : typeof a.querySelectorAll !== x ? a.querySelectorAll(b || "*") : n;
        if (!g)
            for (g = [],
            d = a.childNodes || a; null != (e = d[f]); f++)
                !b || c.nodeName(e, b) ? g.push(e) : c.merge(g, w(e, b));
    ...
    function hb(a, b) {
        for (var d, e, f, g = [], h = 0, k = a.length; h < k; h++)
            ...
            "" === e.style.display && Y(e) && (g[h] = c._data(e, "olddisplay", ib(e.nodeName)))) : g[h] || (f = Y(e),
    ...
    function kb(a, b, d, e, f) {
        ...
        for (var g = 0; 4 > b; b += 2)
            "margin" === d && (g += c.css(a, d + B[b], !0, f)),
            e ? ("content" === d && (g -= c.css(a, "padding" + B[b], !0, f)),
            "margin" !== d && (g -= c.css(a, "border" + B[b] + "Width", !0, f))) : (g += c.css(a, "padding" + B[b], !0, f),
            "padding" !== d && (g += c.css(a, "border" + B[b] + "Width", !0, f)));
        return g
    }
    function lb(a, b, d) {
        var e = !0
    ...
    function ib(a) {
        var b = p
          , d = mb[a];
        d || (d = nb(a, b),
        "none" !== d && d || (Z = (Z || c("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(b.documentElement),
    ...
    function bc(a, b) {
        c.each(b, function(b, c) {
            for (var d = (ja[b] || []).concat(ja["*"]), e = 0, h = d.length; e < h && !d[e].call(a, b, c); e++)
                ;
        })
    }
    function sb(a, b, d) {
        var e, f = 0, g = qa.length, h = c.Deferred().always(function() {
            delete k.elem
        }), k = function() {
            if (e)
                return !1;
    ...
    var ka, x = typeof n, p = t.document, dc = t.location, ec = t.jQuery, fc = t.$, ua = {}, T = [], ub = T.concat, Ha = T.push, A = T.slice, vb = T.indexOf, gc = ua.toString, la = ua.hasOwnProperty, Ia = "1.9.1".trim, c = function(a, b) {
        return new c.fn.init(a,b,hc)
    }, va = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, O = /\S+/g, ic = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, jc = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, wb = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, kc = /^[\],:{}\s]*$/, lc = /(?:^|:|,)(?:\s*\[)+/g, mc = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, nc = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, oc = /^-ms-/, pc = /-([\da-z])/gi, qc = function(a, b) {
        ...
        p.addEventListener ? (p.removeEventListener("DOMContentLoaded", U, !1),
        t.removeEventListener("load", U, !1)) : (p.detachEvent("onreadystatechange", U),
        t.detachEvent("onload", U))
    };
    c.fn = c.prototype = {
        jquery: "1.9.1",
        constructor: c,
    ...
    c.extend({
        ...
        ready: function(a) {
            if (!0 === a ? !--c.readyWait : !c.isReady) {
                ...
                c.isReady = !0;
                !0 !== a && 0 < --c.readyWait || (ka.resolveWith(p, [c]),
        ...
        parseJSON: function(a) {
            ...
            if (null === a)
                return a;
            if ("string" === typeof a && (a = c.trim(a)) && kc.test(a.replace(mc, "@").replace(nc, "]").replace(lc, "")))
    ...
    c.ready.promise = function(a) {
        if (!ka)
            ...
            "complete" === p.readyState)
                ...
                p.addEventListener("DOMContentLoaded", U, !1),
    ...
    c.Callbacks = function(a) {
        a = "string" === typeof a ? Va[a] || Tb(a) : c.extend({}, a);
    ...
    c.extend({
        ...
        when: function(a) {
            var b = 0, d = A.call(arguments), e = d.length, f = 1 !== e || a && c.isFunction(a.promise) ? e : 0, g = 1 === f ? a : c.Deferred(), h = function(a, b, c) {
                return function(d) {
                    b[a] = this;
    ...
    c.support = function() {
        ...
        for (b in {
            ...
            k[b + "Bubbles"] = f in t || !1 === d.attributes[f].expando;
        ...
        c(function() {
            ...
            if (b) {
                ...
                t.getComputedStyle && (k.pixelPosition = "1%" !== (t.getComputedStyle(d, null) || {}).top,
                k.boxSizingReliable = "4px" === (t.getComputedStyle(d, null) || {
                    width: "4px"
                }).width,
                e = d.appendChild(p.createElement("div")),
                ...
                d.style.width = "1px",
                k.reliableMarginRight = !parseFloat((t.getComputedStyle(e, null) || {}).marginRight));
                typeof d.style.zoom !== x && (d.innerHTML = "",
    ...
    c.extend({
        ...
        removeAttr: function(a, b) {
            var d, e = 0, f = b && b.match(O);
            if (f && 1 === a.nodeType)
                for (; d = f[e++]; ) {
                    var g = c.propFix[d] || d;
                    zb.test(d) ? !Q && Ka.test(d) ? a[c.camelCase("default-" + d)] = a[g] = !1 : a[g] = !1 : c.attr(a, d, "");
    ...
    var wc = {
        get: function(a, b) {
            ...
            return (d = "boolean" === typeof d ? La && Q ? null != e : Ka.test(b) ? a[c.camelCase("default-" + b)] : !!e : a.getAttributeNode(b)) && !1 !== d.value ? b.toLowerCase() : n
        },
        set: function(a, b, d) {
    ...
    c.event = {
        ...
        add: function(a, b, d, e, f) {
            ...
            if (h = c._data(a)) {
                ...
                for (h = b.length; h--; ) {
                    ...
                    (m = g[r]) || (m = g[r] = [],
                    m.delegateCount = 0,
                    q.setup && !1 !== q.setup.call(a, e, p, k) || (a.addEventListener ? a.addEventListener(r, k, !1) : a.attachEvent && a.attachEvent("on" + r, k)));
                    q.add && (q.add.call(a, l),
            ...
            if (n && (l = n.events)) {
                ...
                for (k = b.length; k--; ) {
                    ...
                    if (r) {
                        ...
                        for (h = g = w.length; g--; ) {
                            var z = w[g];
                            !f && m !== z.origType || d && d.guid !== z.guid || q && !q.test(z.namespace) || e && e !== z.selector && ("**" !== e || !z.selector) || (w.splice(g, 1),
                            z.selector && w.delegateCount--,
                            t.remove && t.remove.call(a, z))
                        }
                        h && !w.length && (t.teardown && !1 !== t.teardown.call(a, p, n.handle) || c.removeEvent(a, r, n.handle),
                        delete l[r])
                    } else
                        for (r in l)
                            c.event.remove(a, r + b[k], d, e, !0)
                }
        ...
        trigger: function(a, b, d, e) {
            var f, g, h = [d || p], k = la.call(a, "type") ? a.type : a;
            ...
            if (3 !== d.nodeType && 8 !== d.nodeType && !Ab.test(k + c.event.triggered)) {
                ...
                if (e || !l.trigger || !1 !== l.trigger.apply(d, b)) {
                    ...
                    for (g = 0; (m = h[g++]) && !a.isPropagationStopped(); )
                        a.type = 1 < g ? q : l.bindType || k,
                        (f = (c._data(m, "events") || {})[a.type] && c._data(m, "handle")) && f.apply(m, b),
                        (f = C && m[C]) && c.acceptData(m) && f.apply && !1 === f.apply(m, b) && a.preventDefault();
                    a.type = k;
                    if (!(e || a.isDefaultPrevented() || l._default && !1 !== l._default.apply(d.ownerDocument, b) || "click" === k && c.nodeName(d, "a")) && c.acceptData(d) && C && d[k] && !c.isWindow(d)) {
                        (f = d[C]) && (d[C] = null);
                        c.event.triggered = k;
                        try {
                            d[k]()
    ...
    : function(a, b, c) {
        b = "on" + b;
        a.detachEvent && (typeof a[b] === x && (a[b] = null),
        a.detachEvent(b, c))
    }
    ;
    c.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || !1 === a.returnValue || a.getPreventDefault && a.getPreventDefault() ? oa : P) : this.type = a;
        b && c.extend(this, b);
    ...
    (function(a, b) {
            ...
            if (!R && !d) {
                if (e = ja.exec(a))
                    if (g = e[1])
                        ...
                        if (e[2])
                            return B.apply(c, A.call(b.getElementsByTagName(a), 0)),
                            c;
                        if ((g = e[3]) && I.getByClassName && b.getElementsByClassName)
                            return B.apply(c, A.call(b.getElementsByClassName(g), 0)),
                            c
                    }
                if (I.qsa && !W.test(a)) {
                    e = !0;
                    ...
                    if (v)
                        try {
                            return B.apply(c, A.call(g.querySelectorAll(v), 0)),
                            c
                        } catch (Yc) {} finally {
        ...
        function n(a, b) {
            ...
            for (h = y.preFilter; f; ) {
                ...
                if (c = ca.exec(f))
                    ...
                    f = f.slice(v.length);
                for (e in y.filter)
                    !(c = S[e].exec(f)) || h[e] && !(c = h[e](c)) || (v = c.shift(),
                    d.push({
                        value: v,
                        type: e,
                        matches: c
        ...
        function z(a, b, c, d, f, h) {
            ...
            return e(function(e, h, k, v) {
                var K, l = [], m = [], V = h.length, L;
                if (!(L = e)) {
                    L = b || "*";
                    for (var n = k.nodeType ? [k] : k, q = [], r = 0, wa = n.length; r < wa; r++)
                        g(L, n[r], q);
                    L = q
                }
                ...
                if (e) {
                    if (f || a) {
                        ...
                        for (k = n.length; k--; )
                            (K = n[k]) && -1 < (p = f ? Q.call(e, K) : l[k]) && (e[p] = !(h[p] = K))
                    }
                } else
                    n = t(n === h ? n.splice(V, n.length) : n),
                    f ? f(null, h, n, v) : B.apply(h, n)
            })
        }
        function w(a) {
            var b, c, d = a.length, e = y.relative[a[0].type];
            var f = e || y.relative[" "];
        ...
        function sc(a, b) {
            var c = 0
              ...
              , h = function(e, h, k, v, K) {
                var l, m, V = [], n = 0, L = "0", q = e && [], p = null != K, r = M, C = e || f && y.find.TAG("*", K && h.parentNode || h), wa = G += null == r ? 1 : Math.random() || .1;
                p && (M = h !== H && h,
                x = c);
                for (; null != (K = C[L]); L++) {
                    if (f && K) {
        ...
        function D() {}
        var u, x, N, M, H, F, R, W, ra, xa, ta, Na, E = "sizzle" + -new Date, na = a.document, I = {}, G = 0, zc = 0, Db = d(), Cb = d(), O = d(), J = typeof b, aa = [], U = aa.pop, B = aa.push, A = aa.slice, Q = aa.indexOf || function(a) {
            for (var b = 0, c = this.length; b < c; b++)
                if (this[b] === a)
                    return b;
            return -1
        ...
        var sa = g.setDocument = function(a) {
            ...
            if (c === H || 9 !== c.nodeType || !c.documentElement)
                return H;
            H = c;
            F = c.documentElement;
            R = qa(c);
            ...
            ;
            y.find.NAME = I.getByName && function(a, b) {
                if (typeof b.getElementsByName !== J)
                    return b.getElementsByName(name)
            }
            ;
            y.find.CLASS = I.getByClassName && function(a, b) {
                if (typeof b.getElementsByClassName !== J && !R)
                    return b.getElementsByClassName(a)
            }
            ;
            ra = [];
            W = [":focus"];
            if (I.qsa = Z.test(c.querySelectorAll + ""))
                f(function(a) {
            ...
            Na = F.compareDocumentPosition ? function(a, b) {
                var d;
                return a === b ? (N = !0,
                0) : (d = b.compareDocumentPosition && a.compareDocumentPosition && a.compareDocumentPosition(b)) ? d & 1 || a.parentNode && 11 === a.parentNode.nodeType ? a === c || ta(na, a) ? -1 : b === c || ta(na, b) ? 1 : 0 : d & 4 ? -1 : 1 : a.compareDocumentPosition ? -1 : 1
            }
            : function(a, b) {
                var d = 0;
                var e = a.parentNode;
        ...
        g.matchesSelector = function(a, b) {
            ...
            b = b.replace(pa, "='$1']");
            if (!(!I.matchesSelector || R || ra && ra.test(b) || W.test(b)))
                try {
                    var c = xa.call(a, b);
        ...
        g.attr = function(a, b) {
            ...
            (a.ownerDocument || a) !== H && sa(a);
            R || (b = b.toLowerCase());
            return (c = y.attrHandle[b]) ? c(a) : R || I.attributes ? a.getAttribute(b) : ((c = a.getAttributeNode(b)) || a.getAttribute(b)) && !0 === a[b] ? b : c && c.specified ? c.value : null
        }
        ;
        g.error = function(a) {
        ...
        var y = g.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(a) {
                    ...
                    if (S.CHILD.test(a[0]))
                        return null;
                    a[4] ? a[2] = a[4] : c && da.test(c) && (b = n(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && (a[0] = a[0].slice(0, b),
                    a[2] = c.slice(0, b));
                    return a.slice(0, 3)
                }
            },
            filter: {
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    : function(b, c, k) {
                        ...
                        if (m) {
                            ...
                            } else if (k && (q = (b[E] || (b[E] = {}))[a]) && q[0] === G)
                                r = q[1];
                            else
                                for (; (l = ++p && l && l[c] || (r = p = 0) || v.pop()) && ((h ? l.nodeName.toLowerCase() !== n : 1 !== l.nodeType) || !++r || (k && ((l[E] || (l[E] = {}))[a] = [G, r]),
                                l !== b)); )
                                    ;
                            r -= e;
                ...
                PSEUDO: function(a, b) {
                    var c = y.pseudos[a] || y.setFilters[a.toLowerCase()] || g.error("unsupported pseudo: " + a);
                    if (c[E])
                        return c(b);
                    if (1 < c.length) {
                        var d = [a, a, "", b];
            ...
            pseudos: {
                ...
                lang: e(function(a) {
                    ...
                    return function(b) {
                        var c;
                        do
                            if (c = R ? b.getAttribute("xml:lang") || b.getAttribute("lang") : b.lang)
    ...
    c.fn.extend({
        ...
        is: function(a) {
            return !!a && ("string" === typeof a ? Eb.test(a) ? 0 <= c(a, this.context).index(this[0]) : 0 < c.filter(a, this).length : 0 < this.filter(a).length)
        },
    ...
    c.fn.extend({
        ...
        remove: function(a, b) {
            for (var d, e = 0; null != (d = this[e]); e++)
                if (!a || 0 < c.filter(a, [d]).length)
                    b || 1 !== d.nodeType || c.cleanData(w(d)),
                    d.parentNode && (b && c.contains(d.ownerDocument, d) && Ca(w(d, "script")),
                    d.parentNode.removeChild(d));
            return this
        },
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) {
                for (1 === a.nodeType && c.cleanData(w(a, !1)); a.firstChild; )
        ...
        html: function(a) {
            return c.access(this, function(a) {
                var b = this[0] || {}
                  ...
                  , f = this.length;
                if (a === n)
                    return 1 === b.nodeType ? b.innerHTML.replace(Dc, "") : n;
                if (!("string" !== typeof a || Fc.test(a) || !c.support.htmlSerialize && Fb.test(a) || !c.support.leadingWhitespace && Oa.test(a) || D[(Hb.exec(a) || ["", ""])[1].toLowerCase()])) {
                    a = a.replace(Gb, "<$1></$2>");
                    try {
                        for (; e < f; e++)
                            b = this[e] || {},
                            1 === b.nodeType && (c.cleanData(w(b, !1)),
                            b.innerHTML = a);
                        b = 0
                    } catch (g) {}
                }
        ...
        domManip: function(a, b, d) {
            ...
            if (m || !(1 >= g || "string" !== typeof l || c.support.checkClone) && Gc.test(l))
            ...
            if (g) {
                ...
                if (q) {
                    ...
                    for (e = r.length; f < g; f++)
                        q = p,
                        f !== k && (q = c.clone(q, !0, !0),
                        e && c.merge(r, w(q, "script"))),
                        d.call(b && c.nodeName(this[f], "table") ? Xb(this[f], "tbody") : this[f], q, f);
                    if (e)
                        for (p = r[r.length - 1].ownerDocument,
                        c.map(r, db),
                        f = 0; f < e; f++)
                            q = r[f],
                            Jb.test(q.type || "") && !c._data(q, "globalEval") && c.contains(p, q) && (q.src ? c.ajax({
                                url: q.src,
                                type: "GET",
                                dataType: "script",
                                async: !1,
    ...
    c.extend({
        clone: function(a, b, d) {
            ...
            if (c.support.html5Clone || c.isXMLDoc(a) || !Fb.test("<" + a.nodeName + ">"))
                var h = a.cloneNode(!0);
            else
                    ...
                    if (k[f]) {
                        ...
                        if (1 === q.nodeType) {
                            ...
                            if (!c.support.noCloneEvent && q[c.expando]) {
                                e = c._data(q);
                                for (m in e.events)
                                    c.removeEvent(q, m, e.handle);
                                q.removeAttribute(c.expando)
                            }
                            if ("script" === p && q.text !== n.text)
                                cb(q).text = n.text,
                                db(q);
                            else if ("object" === p)
                                q.parentNode && (q.outerHTML = n.outerHTML),
                                c.support.html5Clone && n.innerHTML && !c.trim(q.innerHTML) && (q.innerHTML = n.innerHTML);
                            else if ("input" === p && Da.test(n.type))
                                q.defaultChecked = q.checked = n.checked,
                                q.value !== n.value && (q.value = n.value);
                            else if ("option" === p)
                                q.defaultSelected = q.selected = n.defaultSelected;
                            else if ("input" === p || "textarea" === p)
                                q.defaultValue = n.defaultValue
                        }
                    }
            }
            if (b)
        ...
        buildFragment: function(a, b, d, e) {
            for (var f, g, h, k, l, m, n = a.length, q = ab(b), p = [], t = 0; t < n; t++)
                if ((g = a[t]) || 0 === g)
                    if ("object" === c.type(g))
                        ...
                        if (!c.support.tbody)
                            for (f = (g = "table" !== k || Ib.test(g) ? "<table>" !== m[1] || Ib.test(g) ? 0 : h : h.firstChild) && g.childNodes.length; f--; )
            ...
            for (t = 0; g = p[t++]; )
                if (!e || -1 === c.inArray(g, e))
                    ...
                    h = w(q.appendChild(g), "script"),
                    a && Ca(h),
                    d)
                        for (f = 0; g = h[f++]; )
                            Jb.test(g.type || "") && d.push(g);
            return q
        },
            ...
            for (var d, e, f, g, h = 0, k = c.expando, l = c.cache, m = c.support.deleteExpando, n = c.event.special; null != (d = a[h]); h++)
                if (b || c.acceptData(d))
                    if (g = (f = d[k]) && l[f]) {
                        ...
                        l[f] && (delete l[f],
                        m ? delete d[k] : typeof d.removeAttribute !== x ? d.removeAttribute(k) : d[k] = null,
                        T.push(f))
                    }
        }
    });
    var Z, Qa = /alpha\([^)]*\)/i, Ic = /opacity\s*=\s*([^)]*)/, Jc = /^(top|right|bottom|left)$/, Kc = /^(none|table(?!-c[ea]).+)/, Kb = /^margin/, $b = new RegExp("^(" + va + ")(.*)$","i"), pa = new RegExp("^(" + va + ")(?!px)[a-z%]+$","i"), Lc = new RegExp("^([+-])=(" + va + ")","i"), mb = {
        BODY: "block"
    }, Mc = {
        position: "absolute",
        visibility: "hidden",
        ...
        letterSpacing: 0,
        fontWeight: 400
    }, B = ["Top", "Right", "Bottom", "Left"], gb = ["Webkit", "O", "Moz", "ms"];
    c.fn.extend({
        css: function(a, b) {
        ...
        toggle: function(a) {
            ...
            return this.each(function() {
                (b ? a : Y(this)) ? c(this).show() : c(this).hide()
            })
        }
    });
    c.extend({
        ...
        style: function(a, b, d, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if (d !== n) {
                    var l = typeof d;
                    "string" === l && (f = Lc.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(c.css(a, b)),
                    l = "number");
    ...
    if (t.getComputedStyle) {
        ...
        p.documentElement.currentStyle && (ba = function(a) {
            return a.currentStyle
        }
        ,
        ca = function(a, b, c) {
            var d, f, g = (c = c || ba(a)) ? c[b] : n, h = a.style;
            null == g && h && h[b] && (g = h[b]);
    ...
    c.each(["height", "width"], function(a, b) {
        c.cssHooks[b] = {
            get: function(a, e, f) {
                if (e)
                    return 0 === a.offsetWidth && Kc.test(c.css(a, "display")) ? c.swap(a, Mc, function() {
                        return lb(a, b, f)
                    }) : lb(a, b, f)
            },
            set: function(a, e, f) {
    ...
    c.support.opacity || (c.cssHooks.opacity = {
        ...
        set: function(a, b) {
            ...
            d.zoom = 1;
            if ((1 <= b || "" === b) && "" === c.trim(g.replace(Qa, "")) && d.removeAttribute && (d.removeAttribute("filter"),
            "" === b || e && !e.filter))
                return;
    ...
    c.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name && !c(this).is(":disabled") && Pc.test(this.nodeName) && !Oc.test(a) && (this.checked || !Da.test(a))
            }).map(function(a, b) {
                var d = c(this).val();
    ...
    c.extend({
        ...
        ajax: function(a, b) {
            function d(a, b, d, e) {
                ...
                if (2 !== D) {
                    ...
                    if (d) {
                        var C = m;
                        e = u;
                        var H, w, M, E = C.contents, A = C.dataTypes, I = C.responseFields;
                        for (M in I)
                            M in d && (e[I[M]] = d[M]);
                        for (; "*" === A[0]; )
                            A.shift(),
                            w === n && (w = C.mimeType || e.getResponseHeader("Content-Type"));
                        if (w)
                            for (M in E)
                                if (E[M] && E[M].test(w)) {
                                    A.unshift(M);
                    ...
                    if (200 <= a && 300 > a || 304 === a)
                        if (m.ifModified && ((d = u.getResponseHeader("Last-Modified")) && (c.lastModified[N] = d),
                        (d = u.getResponseHeader("etag")) && (c.etag[N] = d)),
                        204 === a) {
                            var x = !0;
                            l = "nocontent"
                        } else if (304 === a)
                            ...
                            a: {
                                ...
                                w = B.dataTypes.slice();
                                G = w[0];
                                B.dataFilter && (F = B.dataFilter(F, B.dataType));
                                if (w[1])
                                    for (J in B.converters)
                                        l[J.toLowerCase()] = B.converters[J];
                                for (; d = w[++H]; )
                                    if ("*" !== d) {
                                        if ("*" !== G && G !== d) {
                                            var J = l[G + " " + d] || l["* " + d];
                                            if (!J)
                                                for (O in l)
                                                    if (x = O.split(" "),
                                                    x[1] === d && (J = l[G + " " + x[0]] || l["* " + x[0]])) {
                                                        !0 === J ? J = l[O] : !0 !== l[O] && (d = x[0],
                                                        w.splice(H--, 0, d));
                                                        break
                                                    }
                                            if (!0 !== J)
            ...
            a = n);
            b = b || {};
            var e, f, g, h, k, l, m = c.ajaxSetup({}, b), p = m.context || m, q = m.context && (p.nodeType || p.jquery) ? c(p) : c.event, r = c.Deferred(), t = c.Callbacks("once memory"), z = m.statusCode || {}, w = {}, x = {}, D = 0, B = "canceled", u = {
                readyState: 0,
            ...
            var N = m.url;
            m.hasContent || (m.data && (N = m.url += (Sa.test(N) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (m.url = Nb.test(N) ? N.replace(Nb, "$1_=" + Ra++) : N + (Sa.test(N) ? "&" : "?") + "_=" + Ra++));
            m.ifModified && (c.lastModified[N] && u.setRequestHeader("If-Modified-Since", c.lastModified[N]),
            c.etag[N] && u.setRequestHeader("If-None-Match", c.etag[N]));
            ...
            for (e in m.headers)
                u.setRequestHeader(e, m.headers[e]);
            if (m.beforeSend && (!1 === m.beforeSend.call(p, u, m) || 2 === D))
                return u.abort();
            B = "abort";
            for (e in {
                success: 1,
    ...
    var S, Uc = 0, Ua = t.ActiveXObject && function() {
        for (var a in S)
            S[a](n, !0)
    }
    ;
    ...
    var da, za, Vc = /^(?:toggle|show|hide)$/, Wc = new RegExp("^(?:([+-])=|)(" + va + ")([a-z%]*)$","i"), Xc = /queueHooks$/, qa = [function(a, b, d) {
        var e, f = this, g = a.style, h = {}, k = [], l = a.nodeType && Y(a);
        if (!d.queue) {
