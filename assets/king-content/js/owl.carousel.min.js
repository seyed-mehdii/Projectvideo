...
;(function($, window, document, undefined) {
    ...
    Animate.prototype.swap = function() {
        ...
        if (this.core.current() > this.previous) {
            var incomingc = 'slideInUp'
              , outgoingc = 'slideOutUp';
        }
        if (this.core.current() < this.previous) {
            var incomingc = 'slideInDown'
              , outgoingc = 'slideOutDown';
        }
        if (outgoing) {
            left = this.core.coordinates(this.previous) - this.core.coordinates(this.next);
            previous.one($.support.animation.end, clear).css({
                'left': left + 'px'
            }).addClass('animated owl-animated-out').addClass(outgoingc);
        }
        if (incoming) {
            next.one($.support.animation.end, clear).addClass('animated owl-animated-in').addClass(incomingc);
        }
    }
    ;
    Animate.prototype.clear = function(e) {
        $(e.target).css({
            'left': ''
        }).removeClass('animated owl-animated-out owl-animated-in').removeClass('slideInUp').removeClass('slideOutUp').removeClass('slideInDown').removeClass('slideOutDown');
