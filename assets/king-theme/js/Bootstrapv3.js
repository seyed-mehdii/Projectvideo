...
+function(t) {
    ...
    function e(e, i) {
        ...
        if (-1 !== t.inArray(o, i))
            return -1 !== t.inArray(o, s) ? Boolean(e.nodeValue.match(l) || e.nodeValue.match(d)) : !0;
        ...
        for (var a = t.map(o, function(t, e) {
            ...
            if (-1 !== t.inArray(p, a))
                for (var c = t.map(h.attributes, function(t) {
                    return t
                }), u = [].concat(o["*"] || [], o[p] || []), f = 0, g = c.length; g > f; f++)
                    e(c[f], u) || h.removeAttribute(c[f].nodeName);
            else
    ...
    function o(e) {
        return this.each(function() {
            var i = t(this)
              , o = i.data("bs.tooltip")
              , n = "object" == typeof e && e;
            !o && /destroy|hide/.test(e) || (o || i.data("bs.tooltip", o = new h(this,n)),
            "string" == typeof e && o[e]())
        })
    }
    ...
    h.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                ...
                a = "bottom" == a && d.bottom + c > f.bottom ? "top" : "top" == a && d.top - c < f.top ? "bottom" : "right" == a && d.right + p > f.width ? "left" : "left" == a && d.left - p < f.left ? "right" : a,
                n.removeClass(u).addClass(a)
            }
    ...
    h.prototype.hide = function(e) {
        ...
        t.support.transition && n.hasClass("fade") ? n.one("bsTransitionEnd", i).emulateTransitionEnd(h.TRANSITION_DURATION) : i(),
        this.hoverState = null,
        this)
    }
    ,
